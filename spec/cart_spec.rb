...
describe Cart do
  ...
  context "第三種情境：打 10% 折扣" do
    ...
    it "第三集買 1 本、第四集買 1 本、第五集買 1 本" do
      @cart.add({ "1st": 0, "2nd": 0, "3rd": 1, "4th": 1, "5th": 1 })
      expect(@cart.calculate).to eq(270)
    end  

    it "第三集買 2 本、第四集買 2 本、第五集買 2 本" do
      @cart.add({ "1st": 0, "2nd": 0, "3rd": 2, "4th": 2, "5th": 2 })
      expect(@cart.calculate).to eq(540)
    end  

    it "第三集買 2 本、第四集買 3 本、第五集買 2 本" do
      @cart.add({ "1st": 0, "2nd": 0, "3rd": 2, "4th": 3, "5th": 2 })
      expect(@cart.calculate).to eq(640)
    end   

    it "第三集買 2 本、第四集買 3 本、第五集買 4 本" do
      @cart.add({ "1st": 0, "2nd": 0, "3rd": 2, "4th": 3, "5th": 4 })
  ...
  context "第四種情境：打 15% 折扣" do
    ...
    it "第二集買 1 本、第三集買 1 本、第四集買 1 本、第五集買 1 本" do
      @cart.add({ "1st": 0, "2nd": 1, "3rd": 1, "4th": 1, "5th": 1 })
      expect(@cart.calculate).to eq(340)
    end
    ...
    it "第一集買 2 本、第二集買 3 本、第三集買 4 本、第四集買 4 本" do
      @cart.add({ "1st": 2, "2nd": 3, "3rd": 4, "4th": 4, "5th": 0 })
      expect(@cart.calculate).to eq(1140)
    end

    it "第一集買 2 本、第二集買 3 本、第三集買 4 本、第四集買 5 本" do
  ...
  context "第五種情境：打 20% 折扣" do
    ...
    it "第一集買 2 本、第二集買 3 本、第三集買 4 本、第四集買 4 本、第五集買 4 本" do
      @cart.add({ "1st": 2, "2nd": 3, "3rd": 4, "4th": 4, "5th": 4 })
      expect(@cart.calculate).to eq(1410)
    end

    it "第一集買 2 本、第二集買 3 本、第三集買 4 本、第四集買 5 本、第五集買 5 本" do
      @cart.add({ "1st": 2, "2nd": 3, "3rd": 4, "4th": 5, "5th": 5 })
      expect(@cart.calculate).to eq(1600)
    end

    it "第一集買 2 本、第二集買 3 本、第三集買 4 本、第四集買 5 本、第五集買 6 本" do
